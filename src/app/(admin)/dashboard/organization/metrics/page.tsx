                    ...
                    <td className="px-6 py-4 font-medium text-gray-900">
                      ...
                      <div className="mt-1 flex flex-col gap-1.5 sm:hidden font-normal">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="text-[11px] text-gray-500">Order: {metric.displayOrder}</span>
                        </div>
                        {metric.icon ? (
                          <div className="text-[11px] text-gray-500 flex items-center gap-1">
                            <span className="px-1.5 py-0.5 bg-gray-100 rounded-md font-mono text-[10px] text-gray-600">
                              {metric.icon}
                            </span>
                          </div>
                        ) : null}
