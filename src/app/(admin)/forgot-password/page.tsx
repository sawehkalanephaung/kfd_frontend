          ...
          {success ? (
            <div className="space-y-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-slate-800 dark:text-slate-200 text-center text-sm font-medium">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="flex items-center justify-center pt-2">
                <Link href="/login" className="flex items-center gap-1.5 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
