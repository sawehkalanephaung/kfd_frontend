      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            type="button"
            onClick={reset}
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-brand-green-dark px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-brand-green-mid focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-green-dark focus-visible:ring-offset-2"
          >
