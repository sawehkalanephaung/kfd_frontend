...
export function AnnouncementActions({ title }: AnnouncementActionsProps) {
  ...
  return (
    <div className="flex items-center gap-3 print:hidden">
      <button 
        onClick={handleShare}
        className="flex items-center gap-2 border border-gray-300 bg-transparent text-steel hover:text-ink hover:border-gray-400 px-4 py-2 rounded-sm transition-colors"
      >
        <Share2 size={14} />
        {copied ? "Copied!" : "Share"}
      </button>
